...
# ============================================================================
# Version is pinned here AND in argocd/applications/0-argocd-self-app.yaml. (chart 9.4.6 = ArgoCD v3.3.3)
...
helm install argocd argo/argo-cd --namespace argocd --create-namespace --version 9.4.6 --set notifications.secret.create=false --wait
